...
{
    printf("\n=================== HELP SECTION ===================\n");
    printf("This Virtual File System supports the following commands:\n\n");

    printf("1. create <filename> <permission>\n");
    printf("   -> Create a new file with given permission.\n");
    printf("      permission: 1 = READ, 2 = WRITE, 3 = READ+WRITE\n");
    printf("   Example: create myfile 3\n\n");

    printf("2. open <filename> <mode>\n");
    printf("   -> Open an existing file with mode.\n");
    printf("      mode: READ / WRITE / READ+WRITE\n");
    printf("   Example: open myfile READ\n\n");

    printf("3. close <filename>\n");
    printf("   -> Close the given file.\n");
    printf("   Example: close myfile\n\n");

    printf("4. closefd <fd>\n");
    printf("   -> Close file by its file descriptor number.\n");
    printf("   Example: closefd 0\n\n");

    printf("5. closeall\n");
    printf("   -> Close all opened files.\n\n");

    printf("6. write <filename>\n");
    printf("   -> Write data into file. Program will prompt:\n");
    printf("      'Enter the data:' → then type your text and press Enter.\n");
    printf("   Example: write myfile\n\n");

    printf("7. read <filename> <size>\n");
    printf("   -> Read <size> bytes from the file and display.\n");
    printf("   Example: read myfile 20\n\n");

    printf("8. ls\n");
    printf("   -> List all files with their metadata (name, inode, size).\n\n");

    printf("9. stat <filename>\n");
    printf("   -> Display details about file using its name.\n");
    printf("   Example: stat myfile\n\n");

    printf("10. fstat <fd>\n");
    printf("    -> Display details about file using its descriptor.\n");
    printf("    Example: fstat 0\n\n");

    printf("11. truncate <filename>\n");
    printf("    -> Erase all data inside file but keep the file.\n");
    printf("    Example: truncate myfile\n\n");

    printf("12. lseek <fd> <offset> <start|current|end>\n");
    printf("    -> Change the file pointer location.\n");
    printf("    Example: lseek 0 5 start\n\n");

    printf("13. rm <filename>\n");
    printf("    -> Delete (unlink) the file permanently.\n");
    printf("    Example: rm myfile\n\n");

    printf("14. man <command>\n");
    printf("    -> Get manual/help for a specific command.\n");
    printf("    Example: man create\n\n");

    printf("15. exit\n");
    printf("    -> Terminate the Virtual File System program.\n");
...
void CreatrDILB()
{
    ...
    printf("\n====================================================\n");
    printf("          Virtual File System Application\n");
    printf("====================================================\n");
    printf("Type 'help' to see the list of available commands.\n");
    printf("Type 'man <command>' to get details about a command.\n");
